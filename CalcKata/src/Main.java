...
public class Main {
    ...
    public static String calculator(String user_Expression) throws Unchecked_User_Exception {
        ...
        if (array_User_Ex[2].charAt(0)!=' '|array_User_Ex[2].charAt(2)!=' '){
            throw new Unchecked_User_Exception("переменная в ковычка, пробел, знак действия, пробел, вторая переменная целочисленная, либо вторая переменная строковая в ковычках");
        }
